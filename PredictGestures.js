...
function UpdateAccuracy(accuracy) {
    ...
    let headerSting = "------ Percent Correct ------" + "<br>";
    if (sign_ins > 1) {
        ...
        let currString = "Current Session:  " + String(acc) + "%" + "<br>";
        let lastSting = "Previous Session: " + String(prev_accuracyRounded) + "%" + "<br>";
    ...
    var leaderboard = "----- Current Best User -----" + "<br>" + "\n";
